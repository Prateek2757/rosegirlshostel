...
export const site = {
  ...
  phone: "+977 9824068785",
  mobile: "+9779824068785",
  whatsapp: "9779824068785",
  email: "hello@rosegirlshostel.com",
  emergencyPhone: "+977 9824902757",
  address: {
    street: "Mahadevsthan Marg, New Baneshwor",
    city: "Kathmandu",
    postalCode: "44600",
    country: "Nepal",
  ...
  mapEmbedUrl:
    "https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27.696222,85.334833&zoom=17",
  /** Fallback embed that works without an API key. */
  mapEmbedFallback:
    "https://maps.google.com/maps?q=27.696222%2C85.334833&t=&z=17&ie=UTF8&iwloc=&output=embed",
} as const;

export const heroStats = [
  { value: 200, suffix: "+", label: "Happy Residents" },
  { value: 24, suffix: "/7", label: "Security & Support" },
  { value: 100, suffix: " Mbps", label: "High-Speed Wi-Fi" },
